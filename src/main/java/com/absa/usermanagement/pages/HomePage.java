...
public class HomePage extends BasePage {
	...
	public void addUserData(String FirstName, String LastName, String UserName, String Password, String Company,
			String Role, String Mail, String Phone) {
	 ...
	 * @return
	 */
	// For reading the webtable data from webpage and returning the username for
	// verifying whether it is unique or not
